...
mavlink.MAVLINK_MSG_ID_SCRIPT_ITEM = 180;
mavlink.MAVLINK_MSG_ID_SCRIPT_REQUEST = 181;
mavlink.MAVLINK_MSG_ID_SCRIPT_REQUEST_LIST = 182;
mavlink.MAVLINK_MSG_ID_SCRIPT_COUNT = 183;
mavlink.MAVLINK_MSG_ID_SCRIPT_CURRENT = 184;
...
*/
mavlink.messages.script_item = function (target_system, target_component, seq, name) {
    this.format = '<HBB50s';
    this.id = mavlink.MAVLINK_MSG_ID_SCRIPT_ITEM;
    this.order_map = [1, 2, 0, 3];
    this.crc_extra = 231;
    this.name = 'SCRIPT_ITEM';
    this.fieldnames = ['target_system', 'target_component', 'seq', 'name'];
    this.set(arguments);
};
mavlink.messages.script_item.prototype = new mavlink.message;
mavlink.messages.script_item.prototype.pack = function (mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [this.seq, this.target_system, this.target_component, this.name]));
};
/*
...
*/
mavlink.messages.script_request = function (target_system, target_component, seq) {
    this.format = '<HBB';
    this.id = mavlink.MAVLINK_MSG_ID_SCRIPT_REQUEST;
    this.order_map = [1, 2, 0];
    this.crc_extra = 129;
    this.name = 'SCRIPT_REQUEST';
    this.fieldnames = ['target_system', 'target_component', 'seq'];
    this.set(arguments);
};
mavlink.messages.script_request.prototype = new mavlink.message;
mavlink.messages.script_request.prototype.pack = function (mav) {
...
*/
mavlink.messages.script_request_list = function (target_system, target_component) {
    this.format = '<BB';
    this.id = mavlink.MAVLINK_MSG_ID_SCRIPT_REQUEST_LIST;
    this.order_map = [0, 1];
    this.crc_extra = 115;
    this.name = 'SCRIPT_REQUEST_LIST';
    this.fieldnames = ['target_system', 'target_component'];
    this.set(arguments);
};
mavlink.messages.script_request_list.prototype = new mavlink.message;
mavlink.messages.script_request_list.prototype.pack = function (mav) {
...
*/
mavlink.messages.script_count = function (target_system, target_component, count) {
    this.format = '<HBB';
    this.id = mavlink.MAVLINK_MSG_ID_SCRIPT_COUNT;
    this.order_map = [1, 2, 0];
    this.crc_extra = 186;
    this.name = 'SCRIPT_COUNT';
    this.fieldnames = ['target_system', 'target_component', 'count'];
    this.set(arguments);
};
mavlink.messages.script_count.prototype = new mavlink.message;
mavlink.messages.script_count.prototype.pack = function (mav) {
...
*/
mavlink.messages.script_current = function (seq) {
    this.format = '<H';
    this.id = mavlink.MAVLINK_MSG_ID_SCRIPT_CURRENT;
    this.order_map = [0];
    this.crc_extra = 40;
    this.name = 'SCRIPT_CURRENT';
    this.fieldnames = ['seq'];
    this.set(arguments);
};
mavlink.messages.script_current.prototype = new mavlink.message;
mavlink.messages.script_current.prototype.pack = function (mav) {
...
mavlink.map = {
    180: { format: '<HBB50s', type: mavlink.messages.script_item, order_map: [1, 2, 0, 3], crc_extra: 231 },
    181: { format: '<HBB', type: mavlink.messages.script_request, order_map: [1, 2, 0], crc_extra: 129 },
    182: { format: '<BB', type: mavlink.messages.script_request_list, order_map: [0, 1], crc_extra: 115 },
    183: { format: '<HBB', type: mavlink.messages.script_count, order_map: [1, 2, 0], crc_extra: 186 },
    184: { format: '<H', type: mavlink.messages.script_current, order_map: [0], crc_extra: 40 },
