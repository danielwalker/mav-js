...
mavlink.AQ_MAVLINK_DEFS_VERSION_1 = 1 // 
mavlink.AUTOQUAD_MAVLINK_DEFS_VERSION_ENUM_END = 2 // 

// AUTOQUAD_NAV_STATUS
mavlink.AQ_NAV_STATUS_INIT = 0 // System is initializing
mavlink.AQ_NAV_STATUS_STANDBY = 1 // System is *armed* and standing by, with no throttle input and no
                        // autonomous mode
mavlink.AQ_NAV_STATUS_MANUAL = 2 // Flying (throttle input detected), assumed under manual control unless
...
mavlink.AQ_NAV_STATUS_GUIDED = 16 // Externally-guided (eg. GCS) navigation mode
mavlink.AQ_NAV_STATUS_MISSION = 32 // Autonomous mission execution mode
mavlink.AQ_NAV_STATUS_READY = 256 // Ready but *not armed*
mavlink.AQ_NAV_STATUS_CALIBRATING = 512 // Calibration mode active
mavlink.AQ_NAV_STATUS_NO_RC = 4096 // No valid control input (eg. no radio link)
mavlink.AQ_NAV_STATUS_FUEL_LOW = 8192 // Battery is low (stage 1 warning)
mavlink.AQ_NAV_STATUS_FUEL_CRITICAL = 16384 // Battery is depleted (stage 2 warning)
mavlink.AQ_NAV_STATUS_DVH = 16777216 // Dynamic Velocity Hold is active (PH with proportional manual direction
                        // override)
mavlink.AQ_NAV_STATUS_DAO = 33554432 // ynamic Altitude Override is active (AH with proportional manual
                        // adjustment)
...
// MAV_CMD
mavlink.MAV_CMD_AQ_NAV_LEG_ORBIT = 1 // Orbit a waypoint.
